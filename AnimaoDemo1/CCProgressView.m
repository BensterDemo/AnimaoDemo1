...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.gradientLayer.colors = [NSArray arrayWithObjects:(id)[[UIColor colorWithRed:86/255.0f green:201/255.0f blue:85/255.0f alpha:1]CGColor],(id)[[UIColor whiteColor] CGColor], nil];
...
- (void)setProgress:(CGFloat)progress animated:(BOOL)animated
{
    ...
    _currentWaterColor = [UIColor colorWithRed:86/255.0f green:201/255.0f blue:85/255.0f alpha:1];
